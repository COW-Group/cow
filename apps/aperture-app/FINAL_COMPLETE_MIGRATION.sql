-- ============================================================================
-- FINAL COMPLETE MIGRATION - COPY AND PASTE THIS ENTIRE FILE
...
CREATE TABLE IF NOT EXISTS public.user_roles (
  ...
  UNIQUE(user_id, role, context_type, COALESCE(context_id, '00000000-0000-0000-0000-000000000000'::UUID))
);
...
ALTER TABLE public.teams ADD COLUMN IF NOT EXISTS type TEXT DEFAULT 'department' CHECK (type IN ('department', 'project', 'cross-functional', 'external'));
ALTER TABLE public.teams ADD COLUMN IF NOT EXISTS visibility TEXT DEFAULT 'public' CHECK (visibility IN ('public', 'private', 'secret'));
...
ALTER TABLE public.team_members ADD COLUMN IF NOT EXISTS role TEXT DEFAULT 'member' CHECK (role IN ('owner', 'admin', 'member', 'guest'));
