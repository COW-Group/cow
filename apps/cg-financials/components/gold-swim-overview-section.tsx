    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
      ...
      <Card className="border-blue-200 shadow-lg">
        <CardHeader className="pb-3 sm:pb-4 px-4 sm:px-6 py-4 sm:py-6 bg-gradient-to-r from-blue-50 to-cyan-50 border-b border-blue-100">
          <CardTitle className="text-2xl sm:text-3xl font-bold text-blue-700">Gold SWIM</CardTitle>
        </CardHeader>
      ...
      <Card className="border-blue-200 shadow-lg">
        <CardHeader className="pb-3 px-4 sm:px-6 py-4 sm:py-6">
          ...
          <p className="text-xs sm:text-sm text-gray-600 mt-1 italic font-bold">Role of Gold Trade Cycling in Unit Asset Composition</p>
        </CardHeader>
        <CardContent className="pt-0 px-4 sm:px-6 pb-4 sm:pb-6">
