...
import { TrendingUp, Calculator, Hash, Scale, Settings, Info, Sparkles, DollarSign, Percent, Clock } from "lucide-react"
import { useGoldPriceContext } from "@/contexts/gold-price-context"
import { Input } from "@/components/ui/input"
import { Label } from "@/components/ui/label"
import { PARAMETERS } from "@/lib/gold-swim-calculations"
...
export default function GoldSwimOverview({
  ...
  const pricePerUnit = ((spotPriceEUR / 31.1034768) + 15) / (1 - PARAMETERS.transactionBrokerage)
  ...
  const markupAmount = (numberOfGrams * 13) / (1 - PARAMETERS.transactionBrokerage)
  const sourcingCostIncrease = PARAMETERS.sourcingCostIncrease * 100
  const marginPerGram = PARAMETERS.marginPerGram
  const operatingExpPercent = PARAMETERS.operatingExpPercent * 100
  const storageCostPercent = PARAMETERS.storageCostPercent * 100
  const insuranceCostPercent = PARAMETERS.insuranceCostPercent * 100
  const transactionBrokeragePercent = PARAMETERS.transactionBrokerage * 100
  const effectiveTaxRate = PARAMETERS.effectiveTaxRate * 100

  return (
    <div className="space-y-8">
      {/* Investment Calculator Section */}
      <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-2xl shadow-xl border border-blue-200/50 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="group">
              ...
              <div className="relative mt-3">
                ...
                <div className="relative bg-white rounded-xl border-2 border-blue-300 p-4 shadow-lg hover:shadow-xl transition-all">
                  {loading ? (
            ...
            <div className="group">
              ...
              <div className="relative mt-3">
                ...
                <div className="relative bg-white rounded-xl border-2 border-emerald-300 p-4 shadow-lg hover:shadow-xl transition-all">
                  {loading ? (
              ...
              <p className="text-xs text-gray-500 mt-2 ml-1">
                Formula: 25% × Total Unit Subscription
              </p>
            </div>
            ...
            <div className="group">
              ...
              <div className="relative mt-3">
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-xl blur opacity-20 group-hover:opacity-30 transition-opacity"></div>
                <div className="relative bg-white rounded-xl border-2 border-cyan-300 p-4 shadow-lg hover:shadow-xl transition-all">
                  {loading ? (
      ...
      <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-2xl shadow-xl border border-blue-200/50 overflow-hidden">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-5 border-2 border-blue-200 shadow-md hover:shadow-lg transition-all">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-5 border-2 border-amber-300 shadow-md hover:shadow-lg transition-all">
              <div className="flex items-center gap-2 mb-3">
            ...
            <div className="bg-gradient-to-br from-rose-50 to-red-50 rounded-xl p-5 border-2 border-rose-300 shadow-md hover:shadow-lg transition-all">
              <div className="flex items-center gap-2 mb-3">
      ...
      <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-2xl shadow-xl border border-blue-200/50 overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-cyan-500 px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-white">Model Parameters</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white rounded-lg p-4 border-l-4 border-cyan-500 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-gray-700">Margin/Gram</span>
                <div className="flex items-center gap-1">
                  <DollarSign className="h-3.5 w-3.5 text-cyan-600" />
                  <span className="text-base font-bold text-cyan-700">€{marginPerGram.toFixed(2)}</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg p-4 border-l-4 border-blue-500 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-gray-700">Operating Exp</span>
                <div className="flex items-center gap-1">
                  <Percent className="h-3.5 w-3.5 text-blue-600" />
                  <span className="text-base font-bold text-blue-700">{operatingExpPercent}%</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg p-4 border-l-4 border-purple-500 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-gray-700">Trans. Fee</span>
                <div className="flex items-center gap-1">
                  <Percent className="h-3.5 w-3.5 text-purple-600" />
                  <span className="text-base font-bold text-purple-700">{transactionBrokeragePercent}%</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg p-4 border-l-4 border-orange-500 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-gray-700">Storage Cost</span>
                <div className="flex items-center gap-1">
                  <Percent className="h-3.5 w-3.5 text-orange-600" />
                  <span className="text-base font-bold text-orange-700">{storageCostPercent}%</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg p-4 border-l-4 border-pink-500 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-base font-bold text-pink-700">{insuranceCostPercent}%</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg p-4 border-l-4 border-indigo-500 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold text-gray-700">Tax Rate</span>
                <div className="flex items-center gap-1">
                  <Percent className="h-3.5 w-3.5 text-indigo-600" />
                  <span className="text-base font-bold text-indigo-700">{effectiveTaxRate}%</span>
                </div>
              </div>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                desc: "25% of revenue deducted for expenses, leaving 75% as quarterly gains",
              ...
              },
              {
                ...
                desc: "Storage (0.05%) and insurance (0.025%) deducted. 21% tax on realizable gains",
                bgColor: "bg-pink-50",
