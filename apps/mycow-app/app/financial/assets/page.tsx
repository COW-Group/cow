...
export default function AssetsPage() {
  ...
  const [formData, setFormData] = useState({
    name: "",
    amount: "",
    type: "assets" as "income" | "assets",
    category_id: "" as string | null, // Changed to category_id
    description: "",
    work_start_date: "",
    inflow_arrival_date: "",
    frequency: "one-time" as const, // Default to one-time for assets
    color: "#2563eb", // Blue color for assets
  ...
  const loadData = async () => {
    ...
    setInflows(inflowsData.filter((i) => i.type === "assets"))
  ...
  const totalAssets = inflows.reduce((sum, i) => sum + i.amount, 0)
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-light text-ink-800 dark:text-cream-100">Assets</h1>
              <p className="text-ink-600 dark:text-cream-400">Manage your asset inflows</p>
            </div>
          </div>
          ...
          <ZenCard>
            <CardHeader>
              <CardTitle className="text-ink-800 dark:text-cream-100">
                {editingInflow ? "Edit Asset" : "Add New Asset"}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Select
                      value={formData.category_id || "none"} // Updated default value
                  ...
                  <div>
                    <Label htmlFor="work_start_date">Acquisition Date</Label>
                    <Input
                      id="work_start_date"
                      type="date"
                  ...
                  <div>
                    <Label htmlFor="inflow_arrival_date">Last Valuation Date</Label>
                    <Input
                ...
                <div>
                  <Label htmlFor="goal_linked">Linked Goal (Deprecated)</Label>
                  <Input
                    id="goal_linked"
                ...
                <div className="flex gap-2">
                  <Button type="submit" className="bg-logo-blue hover:bg-blue-700 text-white">
                    {editingInflow ? "Update" : "Add"} Asset
                  </Button>
        ...
        <ZenCard>
          <CardHeader>
            <CardTitle className="text-ink-800 dark:text-cream-100">Your Assets</CardTitle>
          </CardHeader>
          <CardContent>
            {isLoading ? (
              <p className="text-ink-600 dark:text-cream-400">Loading...</p>
            ) : inflows.length === 0 ? (
              <p className="text-ink-600 dark:text-cream-400">No assets added yet.</p>
            ) : (
