...
export default function LiabilitiesPage() {
  ...
  const [formData, setFormData] = useState({
    name: "",
    amount: "",
    type: "liabilities" as "expenses" | "liabilities" | "goals",
    ...
    color: "#8b5cf6", // Purple color for liabilities
  ...
  const loadData = async () => {
    ...
    setOutflows(outflowsData.filter((o) => o.type === "liabilities"))
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const outflowData = {
      ...
      goal_vision_level: null, // Liabilities don't link to specific vision items
      goal_vision_item_id: null, // Liabilities don't link to specific vision items
    }
  ...
  const totalLiabilities = outflows.reduce((sum, o) => sum + o.amount, 0)
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-light text-ink-800 dark:text-cream-100">Liabilities</h1>
              <p className="text-ink-600 dark:text-cream-400">Manage your liabilities and debts</p>
            </div>
          </div>
        ...
        {/* Summary Card */}
        <ZenCard className="bg-gradient-to-br from-purple-50/50 to-pink-100/50 dark:from-purple-900/20 dark:to-pink-900/30">
          <div className="flex items-center justify-between">
            <div>
          ...
          <ZenCard>
            <CardHeader>
              <CardTitle className="text-ink-800 dark:text-cream-100">
                {editingOutflow ? "Edit Liability" : "Add New Liability"}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex gap-2">
                  <Button type="submit" className="bg-logo-blue hover:bg-blue-700 text-white">
                    {editingOutflow ? "Update" : "Add"} Liability
                  </Button>
        ...
        <ZenCard>
          <CardHeader>
            <CardTitle className="text-ink-800 dark:text-cream-100">Your Liabilities</CardTitle>
          </CardHeader>
          <CardContent>
            {isLoading ? (
              <p className="text-ink-600 dark:text-cream-400">Loading...</p>
            ) : outflows.length === 0 ? (
              <p className="text-ink-600 dark:text-cream-400">No liabilities added yet.</p>
            ) : (
