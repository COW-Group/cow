...
export const HighlightedSubtitle: React.FC<HighlightedSubtitleProps> = ({
  ...
  const highlightText = (inputText: string) => {
    ...
    // This is important for words like "Wealth Hero" vs "Wealth"
  ...
  return (
    <motion.div
      className="text-center text-ink-800 dark:text-cream-100 text-lg font-medium"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <p
        ...
        className="[&_.highlight]:text-logo-blue [&_.highlight]:dark:text-emerald-400 [&_.highlight]:font-bold"
      />
