...
const ProgressBar: React.FC<{ currentStep: number; totalSteps: number }> = ({ currentStep, totalSteps }) => {
  ...
  return (
    <div className="w-full h-2 bg-cream-200 dark:bg-ink-700 rounded-full overflow-hidden">
      <motion.div
        className="h-full bg-gradient-to-r from-logo-blue to-emerald-500"
        initial={{ width: 0 }}
...
const OnboardingSteps: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      {/* Fixed header */}
      <div className="fixed top-0 left-0 right-0 z-50 p-4 bg-cream-25/95 dark:bg-ink-950/95 backdrop-blur-md border-b border-cream-200/30 dark:border-ink-800/30 safe-area-inset-top">
        <div className="max-w-4xl mx-auto">
          <ProgressBar currentStep={state.currentStep} totalSteps={totalSteps} />
          <div className="flex justify-between items-center mt-2 text-sm text-ink-600 dark:text-cream-400">
            <span>
      ...
      {/* Fixed footer */}
      <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-cream-25/95 dark:bg-ink-950/95 backdrop-blur-md border-t border-cream-200/30 dark:border-ink-800/30 safe-area-inset-bottom">
        <div className="max-w-4xl mx-auto">
...
export const OnboardingContainer: React.FC = () => {
  return (
    <OnboardingProvider>
      <div className="min-h-screen bg-gradient-to-br from-cream-25 via-cream-50 to-blue-50/30 dark:from-ink-950 dark:via-ink-900 dark:to-blue-950/30 overflow-hidden">
        <OnboardingSteps />
      </div>
    </OnboardingProvider>
  )
