  ...
  if (showJourneyMap) {
    return (
      <div className="max-w-4xl mx-auto w-full p-6 bg-cream-50/80 dark:bg-ink-900/80 backdrop-blur-md rounded-xl shadow-lg border border-cream-200/50 dark:border-ink-700/50 mb-20">
        ...
        >
          <div className="mb-8">
            <div className="w-24 h-24 bg-gradient-to-r from-logo-blue to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-6">
              <MapPin className="w-12 h-12 text-white" />
            </div>
            <h2 className="text-3xl font-light text-ink-800 dark:text-cream-100 mb-4">
              Welcome to Your Wealth Journey!
            </h2>
            <p className="text-lg text-ink-600 dark:text-cream-300 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {journeyHighlights.map((highlight, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-ink-800 p-6 rounded-xl shadow-lg border border-cream-200/50 dark:border-ink-700/50"
              >
                <div className="text-logo-blue mb-4">{highlight.icon}</div>
                <h3 className="text-lg font-medium text-ink-800 dark:text-cream-100 mb-2">{highlight.title}</h3>
                <p className="text-sm text-ink-600 dark:text-cream-300">{highlight.description}</p>
              </motion.div>
            ))}
          </div>
          ...
          >
            <h3 className="text-xl font-medium text-ink-800 dark:text-cream-100 mb-2">
              Welcome, {state.firstName}, {state.wealthClass} Hero!
            </h3>
            <p className="text-ink-600 dark:text-cream-300">
      ...
      <div className="max-w-4xl mx-auto w-full p-6 bg-cream-50/80 dark:bg-ink-900/80 backdrop-blur-md rounded-xl shadow-lg border border-cream-200/50 dark:border-ink-700/50 mb-20">
        ...
        >
          <div className="text-center">
            <h2 className="text-2xl font-bold text-ink-800 dark:text-cream-100 mb-4">Create Your Account</h2>
            <p className="text-ink-600 dark:text-cream-300 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white dark:bg-ink-800 p-6 rounded-xl shadow-lg border border-cream-200/50 dark:border-ink-700/50">
              <div className="text-center">
                <UserPlus className="w-12 h-12 text-logo-blue mx-auto mb-4" />
                <h3 className="text-xl font-medium text-ink-800 dark:text-cream-100 mb-2">New to MyCOW?</h3>
                <p className="text-sm text-ink-600 dark:text-cream-300 mb-6">
                  Create a new account to start your wealth journey
                </p>
                <Button
                  onClick={handleSignUp}
                  className="w-full bg-gradient-to-r from-logo-blue to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white"
                >
                  Sign Up
                </Button>
              </div>
            ...
            <div className="bg-white dark:bg-ink-800 p-6 rounded-xl shadow-lg border border-cream-200/50 dark:border-ink-700/50">
              <div className="text-center">
                ...
                <h3 className="text-xl font-medium text-ink-800 dark:text-cream-100 mb-2">Already have an account?</h3>
                <p className="text-sm text-ink-600 dark:text-cream-300 mb-6">Sign in to continue your wealth journey</p>
                <Button
          ...
          <div className="flex justify-between items-center pt-6">
            ...
            <div className="text-sm text-ink-500 dark:text-cream-400">Complete authentication to continue</div>
          </div>
        </motion.div>
      </div>
    )
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <Label htmlFor="phone" className="text-ink-700 dark:text-cream-200 font-medium">
              Phone Number
            </Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="email" className="text-ink-700 dark:text-cream-200 font-medium">
              Email Address
            </Label>
            <div className="relative">
              <Mail
        ...
        {/* Plan Selection */}
        <div>
          <Label className="text-lg font-medium text-ink-700 dark:text-cream-200 mb-4 block">Choose Your Plan</Label>
          <RadioGroup
            value={isPremium ? "premium" : "free"}
            onValueChange={(value) => setIsPremium(value === "premium")}
            className="space-y-4"
          >
            <div className="flex items-center space-x-4 rounded-lg border border-cream-200 dark:border-ink-700 p-6 cursor-pointer hover:bg-cream-100/50 dark:hover:bg-ink-700/50 transition-colors">
              <RadioGroupItem value="free" id="plan-free" />
              <div className="flex-1">
                <Label htmlFor="plan-free" className="cursor-pointer">
                  <div className="flex items-center space-x-3 mb-2">
                    <Sparkles className="w-6 h-6 text-emerald-500" />
                    <span className="text-lg font-medium text-ink-800 dark:text-cream-100">Free Wealth Plan</span>
                  </div>
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-ink-500 dark:text-cream-400">per month</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 rounded-lg border border-cream-200 dark:border-ink-700 p-6 cursor-pointer hover:bg-cream-100/50 dark:hover:bg-ink-700/50 transition-colors">
              ...
              <div className="flex-1">
                <Label htmlFor="plan-premium" className="cursor-pointer">
                  <div className="flex items-center space-x-3 mb-2">
                    <Crown className="w-6 h-6 text-logo-blue" />
                    <span className="text-lg font-medium text-ink-800 dark:text-cream-100">Premium Plan</span>
                    <span className="bg-gradient-to-r from-logo-blue to-emerald-500 text-white text-xs px-2 py-1 rounded-full">
                      RECOMMENDED
                    </span>
                  </div>
                  <p className="text-sm text-ink-600 dark:text-cream-300">
              ...
              <div className="text-right">
                <div className="text-2xl font-bold text-logo-blue">$15</div>
                <div className="text-sm text-ink-500 dark:text-cream-400">per month</div>
              </div>
            </div>
          </RadioGroup>
        ...
        <div className="flex items-start space-x-3 p-4 bg-cream-100/50 dark:bg-ink-800/50 rounded-lg">
          <Checkbox id="terms" checked={agreeToTerms} onCheckedChange={setAgreeToTerms} className="mt-1" />
          <Label htmlFor="terms" className="text-sm text-ink-700 dark:text-cream-200 cursor-pointer">
            I agree to the{" "}
            <a href="#" className="text-logo-blue hover:underline">
              Terms of Service
            </a>{" "}
            and{" "}
            <a href="#" className="text-logo-blue hover:underline">
        ...
        <div className="flex justify-between items-center pt-6">
          ...
          <Button
            ...
            className="bg-gradient-to-r from-logo-blue to-emerald-500 hover:from-logo-blue/90 hover:to-emerald-500/90 text-white disabled:opacity-50 px-8 py-3 text-lg"
          >
