        ...
        >
          <div className="space-y-8">
            <div className="relative">
              <Label className="text-ink-700 dark:text-cream-200 font-medium">Are you 18 or older?</Label>
              <RadioGroup
              ...
              {showBadge && (
                ...
                >
                  <Badge className="bg-gradient-to-r from-logo-blue to-emerald-500 text-white px-3 py-1.5 text-xs font-medium shadow-lg">
                    Ready to Grow
                  </Badge>
                </motion.div>
              )}
            ...
            {isAdult === true && (
              ...
              >
                <Label className="text-ink-700 dark:text-cream-200 font-medium">
