...
export const Step5CashFlow: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto w-full p-4 sm:p-6 bg-cream-50/80 dark:bg-ink-900/80 backdrop-blur-md rounded-xl shadow-lg border border-cream-200/50 dark:border-ink-700/50 mb-20">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div className="space-y-2">
              <Label htmlFor="monthly-income" className="text-ink-700 dark:text-cream-200 text-sm sm:text-base">
            ...
            <div className="space-y-2">
              <Label htmlFor="monthly-expenses" className="text-ink-700 dark:text-cream-200 text-sm sm:text-base">
            ...
            <div className="space-y-2">
              <Label htmlFor="assets" className="text-ink-700 dark:text-cream-200 text-sm sm:text-base">
                Assets (approx. value)
              </Label>
              <div className="relative">
                <DollarSign
            ...
            <div className="space-y-2">
              <Label htmlFor="liabilities" className="text-ink-700 dark:text-cream-200 text-sm sm:text-base">
          ...
          >
            <Button
              variant="outline"
              onClick={prevStep}
              className="w-full sm:w-auto border-cream-300 dark:border-ink-600 hover:bg-cream-100 dark:hover:bg-ink-800 h-10 sm:h-12"
            >
              Back
            </Button>
            ...
            <div className="flex gap-3 w-full sm:w-auto">
              ...
              <Button
                ...
                className="w-full sm:w-auto bg-gradient-to-r from-logo-blue to-emerald-500 hover:from-logo-blue/90 hover:to-emerald-500/90 text-white h-10 sm:h-12"
              >
                Continue
              </Button>
            </div>
