...
export function Milestones({ tokenType }: MilestonesProps) {
  const ausiriMilestones: Milestone[] = [
    {
      id: "1",
      title: "Gold SWIM & SiriZ31 Development",
      description: "Developing foundational analytical tools—Gold SWIM for quarterly retail margin projections and SiriZ31 for futures position analysis with live LBMA pricing",
      date: "Q4 2025",
      status: "in-progress",
    ...
    {
      id: "2",
      title: "Tool Launch & User Validation",
      description: "Launch Gold SWIM and SiriZ31 to initial users—gathering validation data on projection accuracy and futures modeling for AuSIRI foundation",
      date: "Q1 2026",
      status: "upcoming",
    ...
    },
    {
      ...
      description: "Secured initial physical gold reserves in certified vaults with institutional-grade custodial arrangements for AuSIRI backing",
      date: "Q2 2026",
      status: "upcoming",
    ...
    {
      id: "4",
      title: "Registering AuSIRI in Estonia and Cyprus",
      description: "Registered AuSIRI in Estonia and Cyprus, passporting into Luxembourg and other EU nations—following proven AuAERO regulatory pathway",
      date: "Q3 2026",
      status: "upcoming",
      icon: <Shield className="w-5 h-5" />,
    },
    {
      id: "5",
      title: "COW Exchange Integration",
      description: "Integrated AuSIRI into COW Blockchain Exchange Platform, registered in UAE, Qatar, Europe, Hong Kong APAC, Singapore, and the US",
      date: "Q4 2026",
      status: "upcoming",
      icon: <Target className="w-5 h-5" />,
    },
    {
      id: "6",
      title: "AuSIRI Token Launch & Initial Offering",
      description: "Launch AuSIRI token with initial market cap—self-optimizing gold asset backed by reserves and retail margin operations",
      date: "Q1 2027",
      status: "upcoming",
      icon: <TrendingUp className="w-5 h-5" />,
    },
    {
      ...
      description: "Listing AuSIRI on US markets via direct listing or SPAC acquisition—expanding accessibility for US-based investors",
      date: "Q3 2027",
      status: "upcoming",
      icon: <Target className="w-5 h-5" />,
    },
    {
      ...
      description: "Expand physical gold reserves to support growing token supply and increased retail operations scale",
      date: "Q4 2027",
      status: "upcoming",
      icon: <Shield className="w-5 h-5" />,
    },
