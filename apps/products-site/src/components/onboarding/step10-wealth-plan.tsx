      ...
      >
        ...
        <div className="text-center">
          ...
          <div className="max-w-md mx-auto">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-300">{planProgress}% Complete</p>
          </div>
        </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span
                  className={`text-sm font-medium ${
                    section.progress ? "text-emerald-700 dark:text-emerald-300" : "text-slate-600 dark:text-slate-400"
                  }`}
                >
                  {section.name}
                </span>
        ...
        {showPlanPreview && (
          ...
          >
            <div className="text-center mb-6">
              <div className="w-20 h-20 bg-gradient-to-r from-[#0066FF] to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <Star className="w-10 h-10 text-white" />
              </div>
              <h3 className="text-2xl font-light text-slate-800 dark:text-slate-100 mb-2">
                {wealthHeroProfile.name}, the {wealthHeroProfile.class} Hero
              </h3>
              <p className="text-slate-600 dark:text-slate-300">Your Wealth Hero Profile</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-white/50 dark:bg-slate-800/50 rounded-lg">
                <Target className="w-8 h-8 text-[#0066FF] mx-auto mb-2" />
                <div className="text-sm text-slate-600 dark:text-slate-300">Life Stage</div>
                <div className="font-medium text-slate-800 dark:text-slate-100">{wealthHeroProfile.lifeStage}</div>
              </div>

              <div className="text-center p-4 bg-white/50 dark:bg-slate-800/50 rounded-lg">
                <CheckCircle className="w-8 h-8 text-emerald-500 mx-auto mb-2" />
                <div className="text-sm text-slate-600 dark:text-slate-300">Active Goals</div>
                <div className="font-medium text-slate-800 dark:text-slate-100">{wealthHeroProfile.selectedGoals}</div>
              </div>

              <div className="text-center p-4 bg-white/50 dark:bg-slate-800/50 rounded-lg">
                <TrendingUp className="w-8 h-8 text-purple-500 mx-auto mb-2" />
                <div className="text-sm text-slate-600 dark:text-slate-300">Risk Level</div>
                <div className="font-medium text-slate-800 dark:text-slate-100">{wealthHeroProfile.riskLevel}</div>
              </div>
            </div>
          </motion.div>
        )}
        ...
        {planComplete && (
          ...
          >
            ...
            <h3 className="text-xl font-medium text-slate-800 dark:text-slate-100 mb-2">Your plan is ready!</h3>
            ...
            >
              <Button
                onClick={nextStep}
                size="lg"
                className="bg-gradient-to-r from-[#0066FF] to-emerald-500 hover:from-[#0066FF]/90 hover:to-emerald-500/90 text-white px-8 py-3 text-lg"
              >
        ...
        {!planComplete && (
          <div className="flex justify-between items-center pt-6">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-[#0066FF] to-emerald-500 hover:from-[#0066FF]/90 hover:to-emerald-500/90 text-white disabled:opacity-50"
            >
              Continue
            </Button>
          </div>
