    ...
    <div className="max-w-4xl mx-auto w-full p-4 sm:p-6 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md rounded-xl shadow-lg border border-slate-200/50 dark:border-slate-700/50 mb-20">
      ...
      >
            ...
            >
              ...
              {state.skillsToImprove.includes(skill.id) && showSkillTree && (
                <motion.div
                  ...
                  className="absolute -top-2 -right-2 w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-[#0066FF] to-emerald-500 rounded-full flex items-center justify-center shadow-lg"
                >
        ...
        {showSkillTree && state.skillsToImprove.length > 0 && (
          ...
          >
            <h3 className="text-base sm:text-lg font-medium text-slate-800 dark:text-slate-100 mb-4 text-center">
              ...
              {state.skillsToImprove.map((skillId, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex items-center space-x-2 bg-white dark:bg-slate-800 px-3 py-2 sm:px-4 sm:py-2 rounded-full shadow-md"
                  >
                    <div
