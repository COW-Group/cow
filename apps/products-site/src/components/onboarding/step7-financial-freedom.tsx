...
export const Step7FinancialFreedom: React.FC = () => {
  ...
  if (showEducation) {
    return (
      <div className="max-w-4xl mx-auto w-full p-4 sm:p-6 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md rounded-xl shadow-lg border border-slate-200/50 dark:border-slate-700/50 mb-20">
        <motion.div
        ...
        >
          <div className="mb-6 sm:mb-8">
            <TrendingUp className="w-12 h-12 sm:w-16 sm:h-16 mx-auto text-[#0066FF] mb-4" />
            <h2 className="text-xl sm:text-2xl font-light text-slate-800 dark:text-slate-100 mb-4">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-xl shadow-lg mb-4 sm:mb-6"
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-slate-600 dark:text-slate-300">Savings (4% growth)</span>
                  <span className="text-sm font-medium text-slate-800 dark:text-slate-100">$219,112</span>
                </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-slate-600 dark:text-slate-300">Investing (10% growth)</span>
                  <span className="text-sm font-medium text-slate-800 dark:text-slate-100">$630,025</span>
                </div>
                <div className="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-3">
                  <motion.div
          ...
          <motion.p
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 3 }}
            className="text-xs text-ink-500 dark:text-slate-400 mb-4 sm:mb-6"
          >
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 4 }}>
            <Button
              onClick={() => nextStep()}
              className="bg-gradient-to-r from-[#0066FF] to-emerald-500 hover:from-[#0066FF]/90 hover:to-emerald-500/90 text-white px-6 py-3 sm:px-8 sm:py-3 h-10 sm:h-12"
            >
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {goals.map((goal, index) => (
            <motion.div
              ...
              className="space-y-2"
            >
              <Label htmlFor={goal.key} className="text-slate-700 dark:text-slate-200 font-medium text-sm sm:text-base">
                {goal.label}
              </Label>
        ...
        <div className="flex justify-between items-center pt-6">
          <Button
            variant="outline"
            onClick={prevStep}
            className="border-slate-300 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-800 h-10 sm:h-12"
          >
            Back
          </Button>
          <Button
            onClick={handleContinue}
            className="bg-gradient-to-r from-[#0066FF] to-emerald-500 hover:from-[#0066FF]/90 hover:to-emerald-500/90 text-white h-10 sm:h-12"
          >
            Continue
          </Button>
        </div>
