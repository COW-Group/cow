    ...
    <div className="max-w-4xl mx-auto w-full p-6 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md rounded-xl shadow-lg border border-slate-200/50 dark:border-slate-700/50 mb-20">
      ...
      >
        ...
        {stressLevel && (
          ...
          >
            <div className="flex items-center mb-4">
              <CompassIcon className="w-6 h-6 text-[#0066FF] mr-3" />
              <Label className="text-lg font-medium text-slate-700 dark:text-slate-200">
                  ...
                  <div className="flex items-center space-x-3 flex-1">
                    ...
                    <div>
                      <Label htmlFor={`help-${help.value}`} className="cursor-pointer">
                        <div className="font-medium text-slate-800 dark:text-slate-100">{help.label}</div>
                        <div className="text-sm text-slate-600 dark:text-slate-300">{help.description}</div>
                      </Label>
                    </div>
                  </div>
                </div>
        ...
        {showSupportCompass && helpNeeded && (
          <motion.div
            ...
            transition={{ delay: 0.5 }}
            className="bg-gradient-to-r from-pink-50 to-blue-50 dark:from-pslate-900/20 dark:to-blue-900/20 p-6 rounded-xl border border-pink-200/50 dark:border-pslate-800/30"
          >
            <div className="text-center">
              <CompassIcon className="w-12 h-12 text-[#0066FF] mx-auto mb-4" />
              ...
              {stressLevel && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 1 }}
                  className="mt-4 p-3 bg-white/50 dark:bg-slate-800/50 rounded-lg"
                >
