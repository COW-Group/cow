...
import { ArrowRight, TrendingUp, Shield, Zap, ChevronDown, Train, Network, Download } from "lucide-react";
import cowLogo from "../assets/cow-logo.png";

export default function AuRailPage() {
  ...
  const handleAddToCart = (amount: number) => {
    addToCart({
      id: `aurail-${Date.now()}`,
      name: `AuRail Token (${amount.toLocaleString()})`,
      description: "Rail infrastructure and transportation asset-backed token",
      price: amount,
      link: "/aurail",
    });
  };
    ...
    <div className="min-h-screen transition-colors duration-200" style={{ background: 'var(--mode-bg)' }}>
          ...
          <motion.div className="text-center max-w-5xl mx-auto">
            ...
            >
              ...
              <h1 className="text-5xl sm:text-7xl lg:text-8xl font-thin text-gray-800 dark:text-gray-100 mb-6 leading-[0.9] tracking-tight">
                ...
                <br />
                <span style={{
                  background: 'linear-gradient(to right, #9333ea 0%, #a855f7 50%, #c084fc 100%)',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent',
                  backgroundClip: 'text',
                  fontWeight: '300'
                }}>
                  Tokenized Rail Infrastructure
                </span>
              </h1>
              {/* Divider */}
              <div style={{
                width: '120px',
                height: '2px',
                background: 'linear-gradient(to right, transparent 0%, #9333ea 50%, transparent 100%)',
            ...
            >
              ...
              <span style={{ color: '#9333ea', fontWeight: '400' }}>rail infrastructure optimization</span>—discovering how{' '}
              <span className="text-emerald-600 font-normal">transportation tokenization</span> creates accessible investment in essential mobility systems
            </motion.p>
            ...
            >
              ...
              >
                <Button
                  ...
                  onMouseEnter={(e) => e.currentTarget.style.background = 'linear-gradient(to right, #7e22ce, #9333ea)'}
                  onMouseLeave={(e) => e.currentTarget.style.background = 'linear-gradient(to right, #9333ea, #a855f7)'}
              ...
              >
                <Button
                  variant="outline"
                  size="lg"
                  className="px-8 py-6 text-lg font-light border-gray-200 dark:border-gray-700 hover:border-[#9333ea] dark:hover:border-[#a855f7] hover:text-[#9333ea] dark:hover:text-[#a855f7] transition-all duration-300"
                >
                  Learn More
                  <ArrowRight className="ml-3 w-5 h-5" />
                </Button>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                Asset-Backed Rail Infrastructure Investment
              </h3>
              <p
                className="text-lg font-light text-gray-600 dark:text-gray-300 mb-6 leading-relaxed"
                style={{ letterSpacing: '0.01em' }}
              >
                Pioneering tokenized rail infrastructure with{' '}
                <span style={{ color: '#9333ea', fontWeight: '400' }}>transportation network optimization</span>—our rail vertical exploring how fractional ownership transforms infrastructure investment through systematic value generation.
              </p>
              <p
                className="text-base font-light text-gray-600 dark:text-gray-300 mb-8 leading-relaxed"
                style={{ letterSpacing: '0.01em' }}
              >
                Each AuRail token represents verifiable ownership in rail infrastructure, rolling stock, terminal facilities, and operational networks—creating predictable returns from essential transportation systems.
              </p>

              {/* Key Metrics */}
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div>
                  <div className="text-3xl font-light text-[#9333ea] dark:text-[#a855f7] mb-1">100%</div>
                ...
                <div>
                  ...
                  <div className="text-sm font-light text-gray-600 dark:text-gray-400">Q2 2026</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              >
                <Train className="h-32 w-32 text-[#9333ea] dark:text-[#a855f7]" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 px-8" style={{ background: 'var(--mode-how-bg)' }}>
        <style>{`
          ...
          .dark {
            --mode-how-bg: linear-gradient(135deg, rgba(147, 51, 234, 0.05) 0%, transparent 100%);
          }
        `}</style>
        <div className="max-w-7xl mx-auto">
          <div className="mb-20 text-center">
            ...
            >
              Charting New Territory in Rail Investment
            </h2>
            <p
              className="text-lg font-light text-gray-600 dark:text-gray-300 max-w-3xl mx-auto"
              style={{ letterSpacing: '0.01em' }}
            >
              Three systematic flows create sustainable value—from infrastructure acquisition through operations optimization to predictable returns
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            >
              ...
              >
                Token proceeds acquire rail lines, rolling stock, terminals, and maintenance facilities—creating verifiable asset backing with transparent operational reporting
              </p>
            </motion.div>
            ...
            >
              ...
              >
                Systematic route planning and operations management optimize capacity utilization and service efficiency—maximizing revenue from freight and passenger transport
              </p>
            </motion.div>
            ...
            >
              ...
              >
                Transportation fees flow to token holders—creating predictable returns from essential rail infrastructure while supporting sustainable mobility networks
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-32 px-8 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            ...
            >
              Rail Vertical Features
            </h2>
            <h3
              className="text-4xl font-light text-gray-900 dark:text-gray-100"
              style={{ letterSpacing: '-0.02em' }}
            >
              Discovering Value in Transportation Infrastructure
            </h3>
          </div>
            ...
            {[
              {
                ...
                description: "Every token backed by verifiable rail infrastructure—tracks, rolling stock, terminals, and facilities with transparent ownership documentation"
              },
              {
                icon: Network,
                title: "Network Integration",
                description: "Comprehensive transportation networks connecting major economic centers—optimizing freight and passenger services for maximum efficiency"
              },
              {
                icon: TrendingUp,
                title: "Route Optimization",
                description: "Systematic capacity management maximizes utilization—balancing freight and passenger demand for predictable revenue generation"
              },
              {
                icon: Zap,
                title: "Operational Excellence",
                description: "Advanced scheduling and maintenance systems ensure reliability—minimizing downtime while maximizing service quality and safety"
              },
              {
                icon: Shield,
                title: "Regulatory Compliance",
                description: "Full compliance with transportation authorities—maintaining all required certifications and safety standards with transparent reporting"
              },
              {
                icon: Train,
                title: "Fractional Access",
                description: "Tokenization enables accessible infrastructure investment—democratizing rail ownership for sustainable transportation systems"
              }
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
              ...
              >
                <Card className="h-full border-gray-200 dark:border-gray-700/50 bg-white dark:bg-gray-800/50 hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    ...
                    >
                      <feature.icon className="w-6 h-6 text-[#9333ea] dark:text-[#a855f7]" />
                    </div>
                    <CardTitle
      ...
      >
        <style>{`
          :root {
            --mode-cta-bg: linear-gradient(to bottom, rgba(243, 232, 255, 0.3), rgba(147, 51, 234, 0.1));
          }
          .dark {
            --mode-cta-bg: linear-gradient(to bottom, rgba(147, 51, 234, 0.08), rgba(168, 85, 247, 0.08));
          }
        `}</style>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Be among the first to experience tokenized rail infrastructure—pioneering sustainable transportation through infrastructure innovation
          </p>
      ...
      >
        <style>{`
          ...
          .dark {
            --mode-footer-bg: rgba(147, 51, 234, 0.05);
            --mode-footer-border: rgba(147, 51, 234, 0.2);
          }
        `}</style>
