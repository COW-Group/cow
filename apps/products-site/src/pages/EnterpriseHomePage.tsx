...
export default function EnterpriseHomePage() {
  ...
  useEffect(() => {
    ...
    if (onboardingComplete === 'complete') {
      // Don't automatically show auth modal - let user choose when to sign up/login
      ...
      // For enterprise page, we can start with country selection directly
      // or set a different default state
    }
