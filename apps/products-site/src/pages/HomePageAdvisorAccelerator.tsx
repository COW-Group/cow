...
export default function HomePageAdvisorAccelerator() {
  ...
  useEffect(() => {
    ...
    if (onboardingComplete === 'complete') {
      ...
      navigate('/home/advisor-accelerator', { replace: true })
    } else {
          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="mt-12 flex flex-wrap items-center justify-center gap-8 text-white/90">
              <div className="text-center">
                <div className="text-2xl font-light" style={{ letterSpacing: '0.02em', textShadow: '0 1px 3px rgba(0, 0, 0, 0.3)' }}>50-75%</div>
