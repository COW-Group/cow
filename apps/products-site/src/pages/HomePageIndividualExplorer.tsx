...
export default function HomePageIndividualExplorer() {
  ...
  useEffect(() => {
    ...
    if (onboardingComplete === 'complete') {
      ...
      navigate('/home/individual-explorer', { replace: true })
    } else {
      // Set default onboarding data for this page
      const defaultOnboardingData = {
        classificationId: 'explorer',
        classificationTitle: 'Explorer ($10 - $1K)',
          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="mt-12 flex flex-wrap items-center justify-center gap-8 text-white/90">
              <div className="text-center">
                <div className="text-2xl font-light" style={{ letterSpacing: '0.02em', textShadow: '0 1px 3px rgba(0, 0, 0, 0.3)' }}>$10</div>
                <div className="text-sm text-white/70" style={{ letterSpacing: '0.01em' }}>Minimum Start</div>
              </div>
              <div className="w-px h-8 bg-white/20"></div>
              <div className="text-center">
                <div className="text-2xl font-light" style={{ letterSpacing: '0.02em', textShadow: '0 1px 3px rgba(0, 0, 0, 0.3)' }}>15-25%</div>
