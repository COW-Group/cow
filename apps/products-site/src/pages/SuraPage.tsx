...
import { ArrowRight, TrendingUp, Shield, Zap, ChevronDown, Wine, Sparkles, Download } from "lucide-react";
...
export default function SuraPage() {
  ...
  const handleAddToCart = (amount: number) => {
    addToCart({
      id: `sura-${Date.now()}`,
      name: `Sura Token (${amount.toLocaleString()})`,
      description: "Premium spirits production and distribution asset-backed token",
      price: amount,
      link: "/sura",
    });
  };
  ...
  return (
    <div className="min-h-screen transition-colors duration-200" style={{ background: 'var(--mode-bg)' }}>
          ...
          <motion.div className="text-center max-w-5xl mx-auto">
            ...
            >
              ...
              <h1 className="text-5xl sm:text-7xl lg:text-8xl font-thin text-gray-800 dark:text-gray-100 mb-6 leading-[0.9] tracking-tight">
                ...
                <br />
                <span style={{
                  background: 'linear-gradient(to right, #92400e 0%, #b45309 50%, #d97706 100%)',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent',
                  backgroundClip: 'text',
                  fontWeight: '300'
                }}>
                  Tokenized Premium Spirits
                </span>
              </h1>
              {/* Divider */}
              <div style={{
                width: '120px',
                height: '2px',
                background: 'linear-gradient(to right, transparent 0%, #92400e 50%, transparent 100%)',
            ...
            >
              ...
              <span style={{ color: '#92400e', fontWeight: '400' }}>craft spirits optimization</span>—discovering how{' '}
              <span className="text-emerald-600 font-normal">luxury tokenization</span> creates accessible investment in premium whiskey production
            </motion.p>
            ...
            >
              ...
              >
                <Button
                  ...
                  style={{
                    ...
                    boxShadow: '0 25px 50px -12px rgba(146, 64, 14, 0.25)'
                  }}
                  onMouseEnter={(e) => e.currentTarget.style.background = 'linear-gradient(to right, #78350f, #92400e)'}
                  onMouseLeave={(e) => e.currentTarget.style.background = 'linear-gradient(to right, #92400e, #b45309)'}
              ...
              >
                <Button
                  variant="outline"
                  size="lg"
                  className="px-8 py-6 text-lg font-light border-gray-200 dark:border-gray-700 hover:border-[#92400e] dark:hover:border-[#b45309] hover:text-[#92400e] dark:hover:text-[#b45309] transition-all duration-300"
                >
                  Learn More
                  <ArrowRight className="ml-3 w-5 h-5" />
                </Button>
      ...
      <div
        ...
        style={{
          height: '2px',
          background: 'linear-gradient(to right, transparent 0%, rgba(146, 64, 14, 0.3) 50%, transparent 100%)'
        }}
      />

      {/* What is Sura Token Section */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                Asset-Backed Premium Spirits Investment
              </h3>
              <p
                className="text-lg font-light text-gray-600 dark:text-gray-300 mb-6 leading-relaxed"
                style={{ letterSpacing: '0.01em' }}
              >
                Pioneering tokenized whiskey production with{' '}
                <span style={{ color: '#92400e', fontWeight: '400' }}>craft distillery excellence</span>—our spirits vertical exploring how fractional ownership transforms luxury investment through systematic aging and appreciation.
              </p>
              <p
                className="text-base font-light text-gray-600 dark:text-gray-300 mb-8 leading-relaxed"
                style={{ letterSpacing: '0.01em' }}
              >
                Each Sura token represents verifiable ownership in distilleries, aging inventory, production facilities, and premium distribution networks—creating predictable returns from appreciating spirit assets.
              </p>

              {/* Key Metrics */}
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div>
                  <div className="text-3xl font-light text-[#92400e] dark:text-[#b45309] mb-1">100%</div>
                ...
                <div>
                  ...
                  <div className="text-sm font-light text-gray-600 dark:text-gray-400">Q3 2026</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(146, 64, 14, 0.1) 0%, rgba(180, 83, 9, 0.05) 100%)',
                  borderColor: 'rgba(146, 64, 14, 0.2)'
                }}
              >
                <Wine className="h-32 w-32 text-[#92400e] dark:text-[#b45309]" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 px-8" style={{ background: 'var(--mode-how-bg)' }}>
        <style>{`
          ...
          .dark {
            --mode-how-bg: linear-gradient(135deg, rgba(146, 64, 14, 0.05) 0%, transparent 100%);
          }
        `}</style>
        <div className="max-w-7xl mx-auto">
          <div className="mb-20 text-center">
            ...
            >
              Charting New Territory in Spirits Investment
            </h2>
            <p
              className="text-lg font-light text-gray-600 dark:text-gray-300 max-w-3xl mx-auto"
              style={{ letterSpacing: '0.01em' }}
            >
              Three systematic flows create appreciating value—from craft distillation through aging optimization to premium returns
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            >
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 8px 16px rgba(146, 64, 14, 0.2)'
                }}
              >
              ...
              >
                Token proceeds acquire craft distilleries, aging facilities, and premium inventory—creating verifiable asset backing with transparent barrel-level tracking
              </p>
            </motion.div>
            ...
            >
              ...
              >
                Systematic barrel management optimizes maturation profiles—balancing aging time, cask selection, and market timing for maximum appreciation
              </p>
            </motion.div>
            ...
            >
              ...
              >
                Revenue from spirit sales flows to token holders—creating predictable returns from appreciating luxury assets with premium market positioning
              </p>
            </motion.div>
          </div>
        </div>
            ...
            {[
              {
                ...
                description: "Every token backed by verifiable spirits assets—distilleries, aging inventory, and facilities with transparent barrel-level documentation"
              },
              {
                icon: Sparkles,
                title: "Craft Excellence",
                description: "Focus on premium quality production—implementing traditional distillation methods with modern optimization for superior spirits"
              },
              {
                icon: TrendingUp,
                title: "Appreciation Dynamics",
                description: "Aging process creates natural value growth—spirits appreciate over time while maintaining liquid market accessibility"
              },
              {
                icon: Zap,
                title: "Premium Positioning",
                description: "Strategic brand building and distribution—capturing luxury market premiums through quality craftsmanship and limited releases"
              },
              {
                icon: Shield,
                title: "Provenance Tracking",
                description: "Blockchain-verified production records—maintaining authenticity certifications with full supply chain transparency"
              },
              {
                icon: Wine,
                title: "Fractional Ownership",
                description: "Tokenization enables accessible luxury investment—democratizing premium spirits ownership with barrier-free entry"
              }
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
              ...
              >
                <Card className="h-full border-gray-200 dark:border-gray-700/50 bg-white dark:bg-gray-800/50 hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    ...
                    >
                      <feature.icon className="w-6 h-6 text-[#92400e] dark:text-[#b45309]" />
                    </div>
                    <CardTitle
      ...
      >
        <style>{`
          :root {
            --mode-cta-bg: linear-gradient(to bottom, rgba(254, 243, 199, 0.3), rgba(146, 64, 14, 0.1));
          }
          .dark {
            --mode-cta-bg: linear-gradient(to bottom, rgba(146, 64, 14, 0.08), rgba(180, 83, 9, 0.08));
          }
        `}</style>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Be among the first to experience tokenized premium spirits—pioneering luxury investment through craft distillery excellence
          </p>
      ...
      >
        <style>{`
          ...
          .dark {
            --mode-footer-bg: rgba(146, 64, 14, 0.05);
            --mode-footer-border: rgba(146, 64, 14, 0.2);
          }
        `}</style>
